...
authRouter.post(`${nameApi}/auth/login`, asyncHandler(async (req, res, next) => {
...
authRouter.post(`${nameApi}/auth/singin`, asyncHandler(async (req, res) => {
...
authRouter.put(`${nameApi}/auth/update-user-data`, asyncHandler(async (req, res) => {
