...
document.addEventListener('DOMContentLoaded', () => {
    ...
    wondowLoad.createWindow('Cargando publecaciones');
        ...
        */
        ...
        if(e.target.id === 'share-noveltie-Jarvis'){
            ...
            shareWithJarvis(e.target, async data => { 
                ...
                wondowLoad.createWindow('Compartiendo por via Whatsapp');
        ...
        if(e.target.id === 'find-noveltie&show'){ 
            ...
            wondowLoad.createWindow('Cargando publicación');
    ...
    getDataLocal(data => {
        ...
        window.addEventListener('scroll', e => {
            ...
            if (window.innerHeight + window.pageYOffset >= document.body.offsetHeight) {
                if(keyPaginate){
                    keyPaginate = false;
                    wondowLoad.createWindow('Cargando publicaciones');
                    paginate.nextPaginate(novelties => {
